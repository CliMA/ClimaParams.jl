...
[dlt-img]: https://img.shields.io/badge/dynamic/json?url=http%3A%2F%2Fjuliapkgstats.com%2Fapi%2Fv1%2Ftotal_downloads%2FClimaParams&query=total_requests&label=Downloads
...
params = get_parameter_values(
    param_dict,
    Dict("gas_constant" => "R", "gravitational_acceleration" => "g"),
)
